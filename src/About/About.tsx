  ...
  return (
    <div className='about'>
        <div className='aboutDiv'>
            ...
            <p>I am Neeraj Sati, a third year B.Tech CSE student at G.B. Pant Governemnt Engineering College. I am currently practicing Data Structures and algorithms and active in web development. </p>
